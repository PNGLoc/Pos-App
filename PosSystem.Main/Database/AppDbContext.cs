   ...
   new Account
   {
     ...
     new Table { TableID = 71, TableName = "Ship Trụn 6", CategoryID = 4 }
            ...
            modelBuilder.Entity<TableCategory>().HasData(
                new TableCategory { CategoryID = 1, DisplayOrder = 1, CategoryName = "Bàn Thường", Description = "Bàn tiêu chuẩn", BorderColorHex = "#6598C7" },
                new TableCategory { CategoryID = 2, DisplayOrder = 2, CategoryName = "Mang Về", Description = "Khách mang về", BorderColorHex = "#69cf6e" },
                new TableCategory { CategoryID = 3, DisplayOrder = 3, CategoryName = "Khách Lấy", Description = "Khách đến mang đi", BorderColorHex = "#cfc569" },
                new TableCategory { CategoryID = 4, DisplayOrder = 4, CategoryName = "Ship", Description = "Giao hàng tận nơi", BorderColorHex = "#a169cf" }
            );
